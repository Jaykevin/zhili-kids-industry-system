...
(function () {
    ...
    function loadResumes() {
        ...
        if (!userInfo || userInfo.userType !== 2) {
            container.innerHTML = '<div class="no-results">仅企业用户可查看招聘信息，请使用企业账号登录。<br><a href="recruitment.html">返回人才招聘</a></div>';
            return;
        }

        container.innerHTML = '<div class="loading"><i class="bi bi-arrow-repeat"></i><p>加载中...</p></div>';
        fetch(API_BASE + '/auth/job-applications/received', {
            method: 'GET',
            ...
            .then(function (result) {
                ...
                if (!list || list.length === 0) {
                    container.innerHTML = '<div class="no-results">暂无个人用户投递的简历。<br><a href="recruitment.html">返回人才招聘</a></div>';
                    return;
                }
                var html = '';
                list.forEach(function (item) {
                    ...
                    html += '<div class="resume-card">' +
                        ...
                        '<div class="applicant"><i class="bi bi-person"></i> ' + applicantName + (applicantEmail ? ' <span style="color:#999;">(' + applicantEmail + ')</span>' : '') + '</div>' +
